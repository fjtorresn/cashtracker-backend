...
describe('AuthController.createAccount', () => {
    ...
    it('Should return a 409 status and error message if the email is alredy registered', async () => {
    ...
    it('Should register a new user and return a success message', async () => {
        ...
        expect(data).toEqual({ message: 'Cuenta creada exitosamente' });
...
describe('AuthController.login', () => {
    it('Should return 404 if user is not found', async () => {
        ...
        expect(data).toEqual('El usuario no ha sido encontrado');
    });
    ...
    it('Should return 403 if the account has not been confirmed', async () => {
        ...
        expect(data).toEqual('La cuenta debe ser confirmada');
    });
    ...
    it('Should return 401 if the password is incorrect', async () => {
        ...
        expect(data).toEqual('La contraseña es incorrecta');
